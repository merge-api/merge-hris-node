...
var PayGroupApi = (function () {
    function PayGroupApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PayGroupApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PayGroupApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(PayGroupApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    PayGroupApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PayGroupApi.prototype.setApiKey = function (key, value) {
    ...
    PayGroupApi.prototype.payGroupList = function (xAccountToken, createdAfter, createdBefore, cursor, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/pay-group';
    ...
    PayGroupApi.prototype.payGroupRetrieve = function (xAccountToken, id, includeRemoteData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/pay-group/{id}'
