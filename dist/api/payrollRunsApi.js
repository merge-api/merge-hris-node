...
exports.PayrollRunsApi = exports.PayrollRunsApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/hris/v1';
var PayrollRunsApiApiKeys;
(function (PayrollRunsApiApiKeys) {
    PayrollRunsApiApiKeys[PayrollRunsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(PayrollRunsApiApiKeys = exports.PayrollRunsApiApiKeys || (exports.PayrollRunsApiApiKeys = {}));
var PayrollRunsApi = (function () {
    function PayrollRunsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PayrollRunsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PayrollRunsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(PayrollRunsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    PayrollRunsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PayrollRunsApi.prototype.setApiKey = function (key, value) {
        this.authentications[PayrollRunsApiApiKeys[key]].apiKey = value;
    };
    PayrollRunsApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    PayrollRunsApi.prototype.payrollRunsList = function (x_account_token, created_after, created_before, cursor, ended_after, ended_before, include_remote_data, modified_after, modified_before, page_size, remote_id, run_type, started_after, started_before, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/payroll-runs';
                ...
                if (run_type !== undefined) {
                    localVarQueryParameters['run_type'] = models_1.ObjectSerializer.serialize(run_type, "'CORRECTION' | 'OFF_CYCLE' | 'REGULAR' | 'SIGN_ON_BONUS' | 'TERMINATION'");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedPayrollRunList");
    ...
    PayrollRunsApi.prototype.payrollRunsRetrieve = function (x_account_token, id, include_remote_data, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/payroll-runs/{id}'
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PayrollRun");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
...
exports.PayrollRunsApi = PayrollRunsApi;
//# sourceMappingURL=payrollRunsApi.js.map