...
class PayrollRunsApi {
    ...
    payrollRunsList(xAccountToken, createdAfter, createdBefore, cursor, endedAfter, endedBefore, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, runType, startedAfter, startedBefore, options = { headers: {} }) {
    ...
    payrollRunsRetrieve(xAccountToken, id, includeRemoteData, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
