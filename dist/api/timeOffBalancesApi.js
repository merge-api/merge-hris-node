...
var TimeOffBalancesApi = (function () {
    function TimeOffBalancesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(TimeOffBalancesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(TimeOffBalancesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(TimeOffBalancesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    TimeOffBalancesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    TimeOffBalancesApi.prototype.setApiKey = function (key, value) {
        this.authentications[TimeOffBalancesApiApiKeys[key]].apiKey = value;
    };
    TimeOffBalancesApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    TimeOffBalancesApi.prototype.timeOffBalancesList = function (xAccountToken, createdAfter, createdBefore, cursor, employeeId, expand, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, policyType, remoteId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/time-off-balances';
    ...
    TimeOffBalancesApi.prototype.timeOffBalancesRetrieve = function (xAccountToken, id, expand, includeRemoteData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/time-off-balances/{id}'
