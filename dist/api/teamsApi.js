...
var TeamsApi = (function () {
    function TeamsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(TeamsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    TeamsApi.prototype.setApiKey = function (key, value) {
        this.authentications[TeamsApiApiKeys[key]].apiKey = value;
    };
    TeamsApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    TeamsApi.prototype.teamsList = function (xAccountToken, createdAfter, createdBefore, cursor, expand, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, parentTeamId, remoteId, options) {
