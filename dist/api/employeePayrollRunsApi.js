...
exports.EmployeePayrollRunsApi = exports.EmployeePayrollRunsApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/hris/v1';
var EmployeePayrollRunsApiApiKeys;
(function (EmployeePayrollRunsApiApiKeys) {
    EmployeePayrollRunsApiApiKeys[EmployeePayrollRunsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(EmployeePayrollRunsApiApiKeys = exports.EmployeePayrollRunsApiApiKeys || (exports.EmployeePayrollRunsApiApiKeys = {}));
var EmployeePayrollRunsApi = (function () {
    function EmployeePayrollRunsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(EmployeePayrollRunsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(EmployeePayrollRunsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(EmployeePayrollRunsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    EmployeePayrollRunsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    EmployeePayrollRunsApi.prototype.setApiKey = function (key, value) {
        this.authentications[EmployeePayrollRunsApiApiKeys[key]].apiKey = value;
    };
    EmployeePayrollRunsApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    EmployeePayrollRunsApi.prototype.employeePayrollRunsList = function (xAccountToken, createdAfter, createdBefore, cursor, employeeId, endedAfter, endedBefore, expand, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, payrollRunId, remoteId, startedAfter, startedBefore, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/employee-payroll-runs';
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedEmployeePayrollRunList");
    ...
    EmployeePayrollRunsApi.prototype.employeePayrollRunsRetrieve = function (xAccountToken, id, expand, includeRemoteData, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/employee-payroll-runs/{id}'
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "EmployeePayrollRun");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
...
exports.EmployeePayrollRunsApi = EmployeePayrollRunsApi;
//# sourceMappingURL=employeePayrollRunsApi.js.map