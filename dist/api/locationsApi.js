...
exports.LocationsApi = exports.LocationsApiApiKeys = void 0;
...
(function (LocationsApiApiKeys) {
    LocationsApiApiKeys[LocationsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(LocationsApiApiKeys = exports.LocationsApiApiKeys || (exports.LocationsApiApiKeys = {}));
var LocationsApi = (function () {
    function LocationsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(LocationsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(LocationsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(LocationsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    LocationsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    LocationsApi.prototype.setApiKey = function (key, value) {
        this.authentications[LocationsApiApiKeys[key]].apiKey = value;
    };
    LocationsApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    LocationsApi.prototype.locationsList = function (xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/locations';
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedLocationList");
    ...
    LocationsApi.prototype.locationsRetrieve = function (xAccountToken, id, includeRemoteData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/locations/{id}'
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "Location");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
