...
class LocationsApi {
    ...
    locationsList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options = { headers: {} }) {
    ...
    locationsRetrieve(xAccountToken, id, includeRemoteData, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
