...
var TimeOffApi = (function () {
    function TimeOffApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(TimeOffApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    TimeOffApi.prototype.setApiKey = function (key, value) {
    ...
    TimeOffApi.prototype.timeOffList = function (xAccountToken, approverId, createdAfter, createdBefore, cursor, employeeId, expand, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, requestType, status, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    TimeOffApi.prototype.timeOffRetrieve = function (xAccountToken, id, expand, includeRemoteData, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/time-off/{id}'
