...
class TimeOffBalanceApi {
    ...
    timeOffBalanceList(xAccountToken, createdAfter, createdBefore, cursor, employeeId, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, policyType, remoteId, options = { headers: {} }) {
    ...
    timeOffBalanceRetrieve(xAccountToken, id, expand, includeRemoteData, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
