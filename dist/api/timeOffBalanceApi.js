...
exports.TimeOffBalanceApi = exports.TimeOffBalanceApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/hris/v1';
var TimeOffBalanceApiApiKeys;
(function (TimeOffBalanceApiApiKeys) {
    TimeOffBalanceApiApiKeys[TimeOffBalanceApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(TimeOffBalanceApiApiKeys = exports.TimeOffBalanceApiApiKeys || (exports.TimeOffBalanceApiApiKeys = {}));
var TimeOffBalanceApi = (function () {
    function TimeOffBalanceApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(TimeOffBalanceApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(TimeOffBalanceApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(TimeOffBalanceApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    TimeOffBalanceApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    TimeOffBalanceApi.prototype.setApiKey = function (key, value) {
        this.authentications[TimeOffBalanceApiApiKeys[key]].apiKey = value;
    };
    TimeOffBalanceApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    TimeOffBalanceApi.prototype.timeOffBalanceList = function (x_account_token, created_after, created_before, cursor, employee_id, expand, include_remote_data, modified_after, modified_before, page_size, policy_type, remote_id, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/time-off-balance';
                ...
                if (policy_type !== undefined) {
                    localVarQueryParameters['policy_type'] = models_1.ObjectSerializer.serialize(policy_type, "'BEREAVEMENT' | 'JURY_DUTY' | 'PERSONAL' | 'SICK' | 'VACATION' | 'VOLUNTEER'");
                }
    ...
    TimeOffBalanceApi.prototype.timeOffBalanceRetrieve = function (x_account_token, id, expand, include_remote_data, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/time-off-balance/{id}'
...
exports.TimeOffBalanceApi = TimeOffBalanceApi;
//# sourceMappingURL=timeOffBalanceApi.js.map