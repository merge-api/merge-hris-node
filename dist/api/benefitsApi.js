...
class BenefitsApi {
    ...
    benefitsList(xAccountToken, createdAfter, createdBefore, cursor, employeeId, expand, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options = { headers: {} }) {
    ...
    benefitsRetrieve(xAccountToken, id, expand, includeRemoteData, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
