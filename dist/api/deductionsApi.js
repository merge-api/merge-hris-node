...
class DeductionsApi {
    ...
    deductionsList(xAccountToken, createdAfter, createdBefore, cursor, employeePayrollRunId, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options = { headers: {} }) {
    ...
    deductionsRetrieve(xAccountToken, id, includeRemoteData, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
