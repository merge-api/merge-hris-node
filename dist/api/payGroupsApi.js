...
exports.PayGroupsApi = exports.PayGroupsApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/hris/v1';
var PayGroupsApiApiKeys;
(function (PayGroupsApiApiKeys) {
    PayGroupsApiApiKeys[PayGroupsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(PayGroupsApiApiKeys = exports.PayGroupsApiApiKeys || (exports.PayGroupsApiApiKeys = {}));
var PayGroupsApi = (function () {
    function PayGroupsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PayGroupsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PayGroupsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(PayGroupsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    PayGroupsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PayGroupsApi.prototype.setApiKey = function (key, value) {
        this.authentications[PayGroupsApiApiKeys[key]].apiKey = value;
    };
    PayGroupsApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    PayGroupsApi.prototype.payGroupsList = function (xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/pay-groups';
                ...
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling payGroupsList.');
                }
    ...
    PayGroupsApi.prototype.payGroupsRetrieve = function (xAccountToken, id, includeRemoteData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/pay-groups/{id}'
                ...
                localVarFormParams = {};
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling payGroupsRetrieve.');
                }
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling payGroupsRetrieve.');
                }
                if (includeRemoteData !== undefined) {
                    localVarQueryParameters['include_remote_data'] = models_1.ObjectSerializer.serialize(includeRemoteData, "boolean");
                }
...
exports.PayGroupsApi = PayGroupsApi;
//# sourceMappingURL=payGroupsApi.js.map