...
export class EmployeesApi {
     ...
     * @param includeSensitiveFields Whether to include sensitive fields (such as social security numbers) in the response.
     */
    public async employeesRetrieve (xAccountToken: string, id: string, includeRemoteData?: boolean, includeSensitiveFields?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Employee;  }> {
