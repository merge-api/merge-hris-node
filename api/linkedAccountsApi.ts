...
export class LinkedAccountsApi {
     ...
     */
    public async linkedAccountsList (category?: 'accounting' | 'ats' | 'hris', cursor?: number, end_user_email_address?: string, end_user_organization_name?: string, end_user_origin_id?: string, end_user_origin_ids?: string, id?: string, ids?: string, integration_name?: string, is_test_account?: string, page_size?: number, status?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaginatedAccountDetailsAndActionsList;  }> {
