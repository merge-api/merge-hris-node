...
export class EmploymentsApi {
     ...
     */
    public async employmentsCreate (xAccountToken: string, runAsync?: boolean, employmentRequest?: EmploymentRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Employment;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(employmentRequest, "EmploymentRequest")
        };
