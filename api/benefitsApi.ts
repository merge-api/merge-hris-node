...
export class BenefitsApi {
     ...
     * @param createBenefit 
     */
    public async benefitsCreate (xAccountToken: string, runAsync?: boolean, createBenefit?: CreateBenefit, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Benefit;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createBenefit, "CreateBenefit")
        };
