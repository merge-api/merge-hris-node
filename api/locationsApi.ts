...
export class LocationsApi {
     ...
     */
    public async locationsList (xAccountToken: string, cursor?: string, includeRemoteData?: boolean, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaginatedLocationList;  }> {
