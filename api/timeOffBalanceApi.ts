...
export class TimeOffBalanceApi {
     ...
     */
    public async timeOffBalanceList (x_account_token: string, created_after?: Date, created_before?: Date, cursor?: string, employee_id?: string, expand?: 'employee', include_remote_data?: boolean, modified_after?: Date, modified_before?: Date, page_size?: number, policy_type?: '' | 'BEREAVEMENT' | 'JURY_DUTY' | 'null' | 'PERSONAL' | 'SICK' | 'VACATION' | 'VOLUNTEER', remote_id?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaginatedTimeOffBalanceList;  }> {
        ...
        if (policy_type !== undefined) {
            localVarQueryParameters['policy_type'] = ObjectSerializer.serialize(policy_type, "'' | 'BEREAVEMENT' | 'JURY_DUTY' | 'null' | 'PERSONAL' | 'SICK' | 'VACATION' | 'VOLUNTEER'");
        }
